...
export const supplementalTranslations = {
  es: {
    ...
    sentinel1LegendTitle: "Leyenda Sentinel-1",
    sentinel1LikelihoodLow: "Probabilidad del modelo 0.50–0.65",
    sentinel1LikelihoodMedium: "Probabilidad del modelo 0.65–0.80",
    sentinel1LikelihoodHigh: "Probabilidad del modelo 0.80–1.00",
    sentinel1CreditTitle: "Capa experimental Sentinel-1",
    sentinel1CreditText: "Cite como: análisis de daños de datos Copernicus Sentinel-1 por Corey Scher y Jamon Van Den Hoek, Oregon State University. Huellas de edificios: Overture Maps Foundation.",
  ...
  en: {
    ...
    sentinel1LegendTitle: "Sentinel-1 legend",
    sentinel1LikelihoodLow: "Model likelihood 0.50–0.65",
    sentinel1LikelihoodMedium: "Model likelihood 0.65–0.80",
    sentinel1LikelihoodHigh: "Model likelihood 0.80–1.00",
    sentinel1CreditTitle: "Experimental Sentinel-1 layer",
    sentinel1CreditText: "Please cite as: Damage analysis of Copernicus Sentinel-1 data by Corey Scher and Jamon Van Den Hoek of Oregon State University. Overture Maps Foundation building footprint data.",
  ...
  it: {
    ...
    sentinel1LegendTitle: "Legenda Sentinel-1",
    sentinel1LikelihoodLow: "Probabilità del modello 0.50–0.65",
    sentinel1LikelihoodMedium: "Probabilità del modello 0.65–0.80",
    sentinel1LikelihoodHigh: "Probabilità del modello 0.80–1.00",
    sentinel1CreditTitle: "Layer sperimentale Sentinel-1",
    sentinel1CreditText: "Citare come: analisi dei danni da dati Copernicus Sentinel-1 di Corey Scher e Jamon Van Den Hoek, Oregon State University. Impronte degli edifici: Overture Maps Foundation.",
  ...
  zh: {
    ...
    sentinel1LegendTitle: "Sentinel-1 图例",
    sentinel1LikelihoodLow: "模型可能性 0.50–0.65",
    sentinel1LikelihoodMedium: "模型可能性 0.65–0.80",
    sentinel1LikelihoodHigh: "模型可能性 0.80–1.00",
    sentinel1CreditTitle: "实验性 Sentinel-1 图层",
    sentinel1CreditText: "引用方式：Copernicus Sentinel-1 数据损毁分析由 Oregon State University 的 Corey Scher 和 Jamon Van Den Hoek 完成。建筑轮廓数据来自 Overture Maps Foundation。",
